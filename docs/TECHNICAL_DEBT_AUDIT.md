...
Validação realizada: lint e TypeScript sem erros; 123 arquivos de teste e 2.400
testes passando; cobertura global de 90,18% de statements, 84,73% de branches,
90,55% de functions e 91,67% de lines. O CI agora gera o relatório HTML,
