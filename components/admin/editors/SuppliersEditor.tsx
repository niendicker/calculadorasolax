...
export function SuppliersEditor() {
  ...
  const load = useCallback(async () => {
    const [supplierResult, integrationResult, mappingResult, orderResult, inverterResult, batteryResult, accessoryResult] = await Promise.all([
  ...
  async function sync() {
    ...
    if (response.ok) setSupplierSkus([...new Set(result.skus ?? [])] as string[]);
