...
// three sections: identification (Visão geral), the BESS product/sizing
// panel (section 8.1 item 2), the load curve panel (item 3) and the tariff
// panel (item 4). Estratégia/resultados are still separate, larger pieces of
// Fase 6 to come; this only wires the already-built C&I store slice
...
import { BatteryCharging, ClipboardList, Layers3, LineChart, Receipt } from 'lucide-react';
...
type CiWorkspaceSection = 'overview' | 'bess' | 'curve' | 'tariff';
          ...
          <Card className="border-0 ring-0">
            <CardHeader className="flex flex-row items-center gap-3 pb-3">
              ...
              <div>
                ...
                <p className="text-xs text-muted-foreground">Estratégia e resultados de simulação</p>
              </div>
            </CardHeader>
            <CardContent className="pt-0">
              <p className="text-sm text-muted-foreground">
                As próximas seções deste workspace vão permitir escolher a estratégia de despacho e ver os
                resultados da simulação de dimensionamento.
              </p>
            </CardContent>
          </Card>
        </>
