...
// Minimal C&I workspace — docs/CI-MODULE-PLAN.md Fase 6 "fatia estreita":
// just enough UI to create, identify and save a C&I project. The load
// curve/tariff/BESS/results panels are separate, larger pieces of Fase 6
// still to come; this only wires the already-built C&I store slice
...
type CiWorkspaceSection = 'overview';

const navigation: WorkspaceNavItem[] = [{ id: 'overview', label: 'Visão geral', icon: ClipboardList }];
      ...
      <Card className="border-0 ring-0">
        <CardHeader className="flex flex-row items-center gap-3 pb-3">
          ...
          <div>
            ...
            <p className="text-xs text-muted-foreground">Curva de carga, tarifa, equipamento e resultados de simulação</p>
          </div>
        </CardHeader>
        <CardContent className="pt-0">
          <p className="text-sm text-muted-foreground">
            As próximas seções deste workspace vão permitir importar a curva de carga, configurar a tarifa,
            escolher o equipamento BESS e ver os resultados da simulação de dimensionamento.
          </p>
        </CardContent>
      </Card>
    </ProjectWorkspaceShell>
