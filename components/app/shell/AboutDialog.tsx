        ...
        <div className="grid gap-8 p-6 sm:p-8 lg:grid-cols-[0.9fr_1.1fr]">
          <section>
            ...
            <div className="mt-4 space-y-4">
              <div className="flex gap-3"><div className="mt-0.5 rounded-lg bg-primary/10 p-2 text-primary"><ShieldCheck className="h-4 w-4" aria-hidden="true" /></div><div><p className="text-sm font-medium">Dimensionamento guiado</p><p className="mt-1 text-sm leading-5 text-muted-foreground">Escolhas organizadas para chegar a uma solução compatível com o projeto.</p></div></div>
              <div className="flex gap-3"><div className="mt-0.5 rounded-lg bg-primary/10 p-2 text-primary"><Info className="h-4 w-4" aria-hidden="true" /></div><div><p className="text-sm font-medium">Informação técnica</p><p className="mt-1 text-sm leading-5 text-muted-foreground">Detalhes sobre produtos, funcionalidades, margens e premissas do cálculo.</p></div></div>
              <div className="flex gap-3"><div className="mt-0.5 rounded-lg bg-primary/10 p-2 text-primary"><Lightbulb className="h-4 w-4" aria-hidden="true" /></div><div><p className="text-sm font-medium">Produto em evolução</p><p className="mt-1 text-sm leading-5 text-muted-foreground">Suas observações ajudam a priorizar melhorias que tornam o trabalho mais simples.</p></div></div>
            </div>
          </section>
