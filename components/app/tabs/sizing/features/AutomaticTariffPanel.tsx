    ...
    <div className="space-y-4">
      ...
      <div className="rounded-lg border bg-muted/20 p-3 space-y-4">
        ...
        {accessantAgents.length > 0 && (
          <div className="space-y-1.5">
            <Label htmlFor="aneelAccessantAgent">Agente acessante</Label>
            <select
            ...
            >
              <option value="">Selecione um agente acessante (opcional)</option>
            ...
            <p className="text-xs text-muted-foreground">Gerador ou consumidor na rede</p>
          </div>
        )}
