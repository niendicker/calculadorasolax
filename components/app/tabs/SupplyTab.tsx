...
export function SupplyTab() {
  ...
  return <div className="space-y-5 py-5">
    ...
    {/* The shell reserves its own 460px summary column starting at `xl`
     * (see SinglePageApp's grid) — splitting this row at the same breakpoint
     * would leave the offers section fighting for ~150px and overflowing
     * into the cart. Waiting for `2xl` gives both columns room to coexist. */}
